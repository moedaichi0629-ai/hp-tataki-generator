...
export async function GET() {
  ...
  const [
    ...
    supabase.from("stores").select("id", { count: "exact", head: true }).eq("store_status", "prompt_not_created"),
  ...
  return NextResponse.json({
    ...
    promptNotCreatedCount: promptNotCreated.count ?? 0,
